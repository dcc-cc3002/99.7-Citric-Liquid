...
/**
 * A Home Panel is a space in the board of the game that "belongs" to a player.
 *
 */
public class HomePanel extends AbstracPanel {
  ...
  /**
   * Panel is activated by player. Player's currentHp increments in 1
   * and realize a normaCheck.
   *
  ...
  public String toString() {
    return "HomePanel. The owner is: " + owner.getName();
  }
